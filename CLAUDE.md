# CLAUDE.md — Digital Twin Companion
...
| AI | Claude API (claude-sonnet-4-20250514) | Brain del muñeco |
...
- Claude API se llama SOLO cuando el usuario pregunta algo — no en cada frame
...
Fase 3 — AI brain            Claude responde preguntas sobre Antonio.
